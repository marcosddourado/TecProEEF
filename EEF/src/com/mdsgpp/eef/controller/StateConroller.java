...
public class StateConroller {
	...
	private void escreveEstado(Estado estado) {
		...
		this.informacoesEstado
				.put("percentual_participacao_pib",
						dfPorcentagem.format(estado
								.getParticipacaoPercentualPIB()[estado
								.getParticipacaoPercentualPIB().length - 1])
								+ "%");
		this.informacoesEstado.put(
				"projetos_ciencia_tecnologia",
				"Quantidade: "
						+ estado.getProjetosCienciaTecnologia()[estado
								.getProjetosCienciaTecnologia().length - 1]
								.getQuantidade() + " projetos");
		this.informacoesEstado
				.put("valor_ciencia_tecnologia",
						"Valor investido: R$ "
								+ dfValor.format(estado
										.getProjetosCienciaTecnologia()[estado
										.getProjetosCienciaTecnologia().length - 1]
										.getValor()) + " (em mil)");
		this.informacoesEstado.put(
				"ideb_fundamental_final",
				"Ensino Fundamental (series finais): "
						+ dfPorcentagem.format(estado.getIdebs()[estado
								.getIdebs().length - 1].getFundamental()));
		this.informacoesEstado.put(
				"ideb_ensino_medio",
				"Ensino Medio: "
						+ dfPorcentagem.format(estado.getIdebs()[estado
								.getIdebs().length - 1].getMedio()) + "");
		this.informacoesEstado.put(
				"ideb_fundamental_inicial",
				"Ensino Fundamental (Series iniciais): "
						+ dfPorcentagem.format(estado.getIdebs()[estado
								.getIdebs().length - 1].getSeriesIniciais())
						+ "");
		this.informacoesEstado.put(
				"quantidade_primeiros_projetos",
				"Quantidade: "
						+ estado.getPrimeirosProjetos()[estado
								.getPrimeirosProjetos().length - 1]
								.getQuantidade() + " projetos");
		this.informacoesEstado.put(
				"valor_primeiros_projetos",
				"Valor investido: R$ "
						+ dfValor.format(estado.getPrimeirosProjetos()[estado
								.getPrimeirosProjetos().length - 1].getValor())
						+ " (em mil)");
		this.informacoesEstado.put(
				"quantidade_projeto_cnpq",
				"Quantidade: "
						+ estado.getProjetosApoioCnpq()[estado
								.getProjetosApoioCnpq().length - 1]
								.getQuantidade() + " projetos");
		this.informacoesEstado.put(
				"valor_projetos_cnpq",
				"Valor investido: R$ "
						+ dfValor.format(estado.getProjetosApoioCnpq()[estado
								.getProjetosApoioCnpq().length - 1].getValor())
						+ " (em mil)");
		this.informacoesEstado.put(
				"quantidade_projeto_jovens_pesquisadores",
				"Quantidade: "
						+ estado.getProjetoJovensPesquisadores()[estado
								.getProjetoJovensPesquisadores().length - 1]
								.getQuantidade() + " projetos");
		this.informacoesEstado
				.put("valor_projetos_jovens_pesquisadores",
						"Valor investido: R$ "
								+ dfValor.format(estado
										.getProjetoJovensPesquisadores()[estado
										.getProjetoJovensPesquisadores().length - 1]
										.getValor()) + " (em mil)");
		this.informacoesEstado
				.put("quantidade_projetos_inct",
						"Quantidade: "
								+ estado.getProjetosInct()[estado
										.getProjetosInct().length - 1]
										.getQuantidade() + " projetos");
		this.informacoesEstado.put(
				"valor_projetos_inct",
				"Valor investido: R$ "
						+ dfValor.format(estado.getProjetosInct()[estado
								.getProjetosInct().length - 1].getValor())
						+ " (em mil)");

		this.informacoesEstado.put(
				"alunos_por_turma_ensino_fundamental",
				"Quantidade media de alunos por turma (Fundamental): "
						+ dfValor.format(estado.getMediaAlunosPorTurma()[estado
								.getMediaAlunosPorTurma().length - 1]
		...
		this.informacoesEstado.put(
				...
				"Quantidade media de horas de aula(Fundamental): "
						+ dfValor.format(estado.getMediaHorasAula()[estado
								.getMediaHorasAula().length - 1]
								.getEnsinoFundamental()));
		this.informacoesEstado.put(
		...
		this.informacoesEstado.put(
				...
				"Quantidade de Distoreeo da Idade(Fundamental): "
						+ dfPorcentagem.format(estado
								.getTaxaDistorcaoIdadeSerie()[estado
								.getTaxaDistorcaoIdadeSerie().length - 1]
								.getEnsinoFundamental()));
		this.informacoesEstado.put(
		...
		this.informacoesEstado
				.put("taxa_aprovacao_fundamental",
						"Taxa de Aprovaeeo (Fundamental): "
								+ dfPorcentagem.format(estado
										.getTaxaDeAproveitamento()[estado
										.getTaxaDeAproveitamento().length - 1]
										.getEnsinoFundamental()));
		this.informacoesEstado
		...
		this.informacoesEstado
				.put("taxa_abandono_fundamental",
						"Taxa de Abandono (Fundamental): "
								+ dfPorcentagem.format(estado
										.getTaxaDeAbandono()[estado
										.getTaxaDeAbandono().length - 1]
										.getEnsinoFundamental()));
		this.informacoesEstado
		...
		this.informacoesEstado.put(
				...
				"Censo Anos Iniciais (Fundamental): "
						+ dfPorcentagem.format(estado.getCensos()[estado
								.getCensos().length - 1]
		...
		this.informacoesEstado.put(
				...
				"Censo Ensino Medio: "
						+ dfPorcentagem.format(estado.getCensos()[estado
								.getCensos().length - 1].getEnsinoMedio()));
		this.informacoesEstado.put(
				"censo_eja_fundamental",
				"Censo EJA (Fundamental): "
						+ dfPorcentagem.format(estado.getCensos()[estado
								.getCensos().length - 1].getFundamentalEJA()));
		this.informacoesEstado.put(
				"censo_eja_medio",
				"Censo EJA (Medio): "
						+ dfPorcentagem.format(estado.getCensos()[estado
								.getCensos().length - 1].getMedioEJA()));
	...
	private void escreveEstadoComTodasInformacoes(Estado estado) {
		...
		for (int i = 0, ano = 1995; i < estado.getParticipacaoPercentualPIB().length; i++, ano++)
			temp += ano
					+ ": "
					+ dfPorcentagem.format(estado
							.getParticipacaoPercentualPIB()[i]) + "%\n";
		...
		for (int i = 0, ano = 2003; i < estado.getProjetosCienciaTecnologia().length-1; i++, ano++) {
			temp += ano
					+ ": "
					+ "Quantidade: "
					+ estado.getProjetosCienciaTecnologia()[i].getQuantidade()
					+ " projetos\n"
					+ "\t\t "
					+ "  Valor investido: R$ "
					+ dfValor.format(estado.getProjetosCienciaTecnologia()[i]
							.getValor()) + " (em mil)\n\n";
		}
		...
		for (int i = 0, ano = 2005; i < estado.getIdebs().length; i++, ano += 2) {
			temp += ano
					+ ": "
					+ "Ensino Fundamental (series finais): "
					+ dfPorcentagem.format(estado.getIdebs()[i]
							.getFundamental())
					+ "\n"
					+ "\t\t  "
					+ "Ensino Medio: "
					+ dfPorcentagem.format(estado.getIdebs()[i].getMedio())
					+ "\n"
					+ "\t\t  "
					+ "Ensino Fundamental (Series iniciais): "
					+ dfPorcentagem.format(estado.getIdebs()[i]
		...
		for (int i = 0, ano = 2007; i < estado.getPrimeirosProjetos().length-1; i++, ano++) {
			temp += ano
					+ ": "
					+ "Quantidade: "
					+ estado.getPrimeirosProjetos()[i].getQuantidade()
					+ " projetos\n"
					+ "\t\t  "
					+ "Valor investido: R$ "
					+ dfValor.format(estado.getPrimeirosProjetos()[estado
		...
		for (int i = 0, ano = 2001; i < estado.getProjetosApoioCnpq().length-1; i++, ano++) {
			temp += ano
					+ ": "
					+ "Quantidade: "
					+ estado.getProjetosApoioCnpq()[i].getQuantidade()
					+ " projetos\n"
					+ "\t\t  "
					+ "Valor investido: R$ "
					+ dfValor.format(estado.getProjetosApoioCnpq()[i]
							.getValor()) + " (em mil)\n\n";
		}
		...
		for (int i = 0, ano = 2005; i < estado.getProjetoJovensPesquisadores().length-1; i++, ano++) {
			temp += ano
					...
					+ "\t\t  "
					+ "Valor investido: R$ "
					+ dfValor.format(estado.getProjetoJovensPesquisadores()[i]
							.getValor()) + " (em mil)\n\n";
		}
		...
		for (int i = 0, ano = 2008; i < estado.getProjetosInct().length-1; i++, ano++) {
			temp += ano + ": " + "Quantidade: "
					...
					+ " projetos\n" + "\t\t  " + "Valor investido: R$ "
					+ dfValor.format(estado.getProjetosInct()[i].getValor())
					+ " (em mil)\n\n";
		}
		...
		for (int i = 0, ano = 2007; i < estado.getMediaAlunosPorTurma().length; i++, ano++) {
			temp += ano
					+ ": "
					+ "Quantidade media de alunos por turma (Fundamental): "
					+ dfValor.format(estado.getMediaAlunosPorTurma()[i]
							.getEnsinoFundamental())
					+ "\n"
					+ "Quantidade media de alunos por turma (Medio): "
					+ dfValor.format(estado.getMediaAlunosPorTurma()[i]
		...
		for (int i = 0, ano = 2007; i < estado.getMediaAlunosPorTurma().length; i++, ano++) {
			temp += ano
					...
					+ "Quantidade media de horas de aula (Medio): "
					+ dfValor.format(estado.getMediaHorasAula()[estado
							.getMediaHorasAula().length - 1].getEnsinoMedio())
					+ "\n\n";
		}
		...
		for (int i = 0, ano = 2006; i < estado.getTaxaDistorcaoIdadeSerie().length; i++, ano++) {
			temp += ano
					...
					+ "Quantidade de Distoreeo da Idade(Fundamental): "
					+ dfPorcentagem
							.format(estado.getTaxaDistorcaoIdadeSerie()[i]
									.getEnsinoFundamental())
					+ "\n"
					+ "Quantidade de Distoreeo da Idade (Medio): "
					+ dfPorcentagem
		...
		for (int i = 0, ano = 2007; i < estado.getTaxaDeAproveitamento().length; i++, ano++) {
			temp += ano
					+ ": "
					+ "Taxa de Aprovaeeo (Fundamental): "
					+ dfPorcentagem.format(estado.getTaxaDeAproveitamento()[i]
							.getEnsinoFundamental())
					+ "\n"
					+ "\t\t  "
					+ "Taxa de Aprovaeeo (Medio): "
		...
		for (int i = 0, ano = 2007; i < estado.getTaxaDeAbandono().length; ano++, i++) {
			temp += ano
					+ ": "
					+ "Taxa de Abandono (Fundamental): "
					+ dfPorcentagem.format(estado.getTaxaDeAbandono()[i]
							.getEnsinoFundamental())
					+ "\n"
					+ "\t\t  "
					+ "Taxa de Abandono (Medio): "
		...
		for (int i = 0, ano = 2010; i < estado.getCensos().length; ano++, i++) {
			temp += ano
					+ ": "
					+ "Censo Anos Iniciais (Fundamental): "
					+ dfPorcentagem.format(estado.getCensos()[i]
							.getAnosIniciaisFundamental())
					+ "\n"
					+ "\t\t  "
					+ "Censo Anos Finais (Fundamental): "
	...
	private void PreencherNomeSiglaEPopulacao(Estado estado) {
		...
		;
		this.informacoesEstado.put("populacao",
				dfPopulacao.format(estado.getPopulacao()) + " habitantes");
	}
