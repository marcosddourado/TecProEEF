...
public class StateConroller {
    ...
    private static final int STATE_ABBREVIATION = 1;
    private static StateConroller instance = null;
    private Context context = null;
    private HashMap<String, String> stateInformations = new HashMap<String, String>();
    private HashMap<String, ArrayList<String[]>> parseInformations = new HashMap<String, ArrayList<String[]>>();
    ...
    public State grabState(int position) throws IOException {
        ...
        String nameAndAbbreviation[] = parseInformations.get("name_and_abbreviation").get(0);
        State state = new State(nameAndAbbreviation[STATE_NAME],
                nameAndAbbreviation[STATE_ABBREVIATION],
                parseInformations);
